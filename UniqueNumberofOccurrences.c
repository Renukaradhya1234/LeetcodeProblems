...
void quickSort(int* array, int start_index, int end_index) {
    if (start_index < end_index) {
        ...
        quickSort(array, pivot_index+1, end_index); /// right half array....
        quickSort(array, start_index, pivot_index-1); /// left half array....
    }
}
